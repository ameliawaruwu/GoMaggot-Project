...
if (isset($_POST['btnSubmit'])) {
    ...
    // Handle gambar
    $gambar = $produk['gambar']; // Default tetap menggunakan gambar lama
...
<div class="edit-form-container">
    ...
    <form method="post" enctype="multipart/form-data" id="editProductForm">
        <table class="form-table">
            ...
            <tr>
                <td><label for="productStock" class="required-field">Stok</label></td>
                <td>:</td>
                <td>
                    <input type="number" id="productStock" name="productStock" class="form-input" min="0" value="<?= $produk['stok'] ?>" required>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td valign="top">:</td>
                <td>
                    <textarea id="productDescription" name="productDescription" class="form-textarea"><?= htmlspecialchars($produk['deskripsi_produk']) ?></textarea>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    ...
                    <span class="form-helper">Biarkan kosong jika tidak ingin mengganti gambar</span>
                    
                    <?php if (!empty($produk['gambar'])): ?>
                    <div class="current-image-container">
                        <span class="current-image-label">Gambar Saat ini:</span>
                        <img src="photos/<?= htmlspecialchars($produk['gambar']) ?>" alt="<?= htmlspecialchars($produk['namaproduk']) ?>" class="current-image">
                    </div>
                    <?php endif; ?>
                    
                    <div id="imagePreview" class="preview-container">
                        <span class="preview-label">Gambar Baru:</span>
        ...
        <div class="form-actions">
            ...
            <button type="submit" name="btnSubmit" class="btn btn-primary">Simpan Perubahan</button>
        </div>
    </form>
</div>
...
window.addEventListener('beforeunload', function(e) {
    ...
    if (formChanged) {
        ...
        const message = 'Anda memiliki perubahan yang belum disimpan. Yakin ingin meninggalkan halaman ini?';
