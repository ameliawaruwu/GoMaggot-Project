...
if (isset($_POST['btnSubmit'])) {
    ...
    if (!isset($error)) {
        ...
        $sqlInsert = "INSERT INTO produk (namaproduk, kategori, harga, stok, deskripsi_produk, masapenyimpanan, berat, gambar) 
                      VALUES ('$nama_produk', '$kategori', '$harga', '$stok', '$deskripsi', '$masa_penyimpanan', '$berat_produk', '$gambar')";
    ...
    <form method="post" enctype="multipart/form-data" id="addProductForm">
        <table class="form-table">
                ...
                <td>
                    <select id="productCategory" name="productCategory" class="form-select" required>
                        ...
                        foreach ($arrKategori as $kategori) {
                            $selected = ($kategori['kategori'] == $form_data['productCategory']) ? 'selected' : '';
                        ?>
                        <option value="<?= $kategori['kategori'] ?>" <?= $selected ?>><?= $kategori['kategori'] ?></option>
                        <?php } ?>
                        <option value="BSF" <?= ($form_data['productCategory'] == 'BSF') ? 'selected' : '' ?>>BSF</option>
                        <option value="Kompos" <?= ($form_data['productCategory'] == 'Kompos') ? 'selected' : '' ?>>Kompos</option>
                        <option value="Pupuk" <?= ($form_data['productCategory'] == 'Pupuk') ? 'selected' : '' ?>>Pupuk</option>
                        <option value="Lainnya" <?= ($form_data['productCategory'] == 'Lainnya') ? 'selected' : '' ?>>Lainnya</option>
                    </select>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td>:</td>
                <td>
                    <input type="number" id="productStock" name="productStock" class="form-input" min="0" value="<?= $form_data['productStock'] ?>" required>
                </td>
            </tr>
            <tr>
